...
const CategoryManager = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get('https://deployment-370a.onrender.com/api/categories/tree');
  ...
  const handleSubmit = async () => {
    try {
      ...
      const url = editMode 
        ? `https://deployment-370a.onrender.com/api/categories/${formValues._id}`
        : 'https://deployment-370a.onrender.com/api/categories';
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://deployment-370a.onrender.com/api/categories/${id}`);
      fetchCategories();
