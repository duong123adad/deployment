...
function ReturnHistory() {
  ...
  const fetchReturns = async () => {
    ...
    try {
      ...
      const response = await axios.get("https://deployment-370a.onrender.com/api/returns", {
        params,
        headers: {
      ...
      // Fetch statistics
      const statsResponse = await axios.get("https://deployment-370a.onrender.com/api/returns/statistics", {
        params: {
  ...
  const handleStatusUpdate = async (id, status) => {
    try {
      await axios.patch(`https://deployment-370a.onrender.com/api/returns/${id}/status`, { status });
      fetchReturns();
  ...
  const handleResendEmail = async (id) => {
    try {
      await axios.post(`https://deployment-370a.onrender.com/api/returns/${id}/resend-email`);
