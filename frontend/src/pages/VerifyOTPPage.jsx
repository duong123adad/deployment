...
const VerifyOTPPage = () => {
    ...
    const handleVerifyOTP = async (e) => {
        ...
        try {
            const response = await axios.post(
                "https://deployment-370a.onrender.com/api/auth/verify-customer-signup",
                { otp },
                {
    ...
    const handleResendOTP = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                "https://deployment-370a.onrender.com/api/auth/initiate-customer-signup", // Gọi lại API gửi OTP
                { email: storedEmail },
                {
                    withCredentials: true, // Important for sending cookies
                }
