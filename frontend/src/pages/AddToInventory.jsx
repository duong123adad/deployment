...
const AddToInventory = () => {
  ...
  const fetchReceipts = async () => {
    try {
      setLoading(true);
      setError(null);
      const res = await axios.get('https://deployment-370a.onrender.com/api/goodreceipt',
        {
          headers: {
  ...
  const handleConfirm = async (receiptId) => {
    try {
      ...
      const res = await axios.patch(`https://deployment-370a.onrender.com/api/goodreceipt/confirm/${receiptId}`, {}, config);
