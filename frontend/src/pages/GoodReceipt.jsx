...
const CreateGoodReceipt = () => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      const purchaseOrdersRes = await axios.get("https://deployment-370a.onrender.com/api/purchaseOrder", {
        headers: {
  ...
  const fetchSupplierProducts = async (supplierId) => {
    ...
    try {
      ...
      const allProductsResponse = await axios.get("https://deployment-370a.onrender.com/api/products", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      const supplierResponse = await axios.get(`https://deployment-370a.onrender.com/api/suppliers/${supplierId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      if (supplierResponse.data && supplierResponse.data.suppliedProducts) {
        ...
        const response = await axios.get(`https://deployment-370a.onrender.com/api/products/supplier/${supplierId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const handleSelectOrder = async (orderId) => {
    ...
    try {
      const res = await axios.get(
        `https://deployment-370a.onrender.com/api/purchaseorder/${orderId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://deployment-370a.onrender.com/api/goodreceipt/from-po",
        requestData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      const confirmResponse = await axios.patch(
        `https://deployment-370a.onrender.com/api/goodreceipt/confirm/${response.data._id}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const fetchReceiptDetails = async (receiptId) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://deployment-370a.onrender.com/api/goodreceipt/${receiptId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
